...
EOF
    echo -n "${NC}"
    echo "   ${BL}Created by Ryan Summer${NC}                ${BL}For macOS 10.10-27${NC}           ${BL}v2.5${NC}"
}
# Navigation prompt
...
function resources() {
    while true; do  
        ...
        show_navigation_prompt_centered  # already padded
        echo "🔗 ${BO}Links:${NC}"
        echo " 1) ${GR}Download the latest UAD Software installer${NC} ${BO}${GY}(UAD_12_0_0_602.pkg)${NC}"
        ...
        case $choice in
            1)
                ...
                open https://builds.uaudio.com/apps/uad2/UAD_12_0_0_602.pkg; open https://help.uaudio.com/hc/en-us/articles/215267203-UAD-DSP-Plugins-and-Drivers-Software-Archives#h_01KHYDYEFMPTAV426PVCGRJ0JY
                ;;
            2) 
                # Download previous UAD Software versions
                open https://help.uaudio.com/hc/en-us/articles/215267203-UAD-Software-Archives
                ;;
            3)
            ...
            4)
                ...
                elif [[ -d "/Applications/Universal Audio/Uninstall UAD DSP Plug-Ins and Drivers.app" ]]; then
                    open "/Applications/Universal Audio/Uninstall UAD DSP Plug-Ins and Drivers.app"
                else
                    echo
